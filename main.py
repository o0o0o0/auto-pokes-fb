...
# By clarisha octa (clarishaocta@hackermail.net)
#
# Requires :
#  - Python 2.7
#    http://python.org
...
# Misc Functions code by clarisha octa
...
def poke_user(data, friend_id):
    ...
    # Set up POST data ladies viking 1933
    pdata = {}
    pdata["uid"] = friend_id
    pdata["pokeback"] = "1"
